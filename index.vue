<template>
  ...
  <section id="hero">
    ...
    <div id="cont_tv">
      ...
      <video poster="/img/preview.jpg" autoplay muted loop playsinline>
    ...
    <section id="home_posters" >
      ...
      <div id="cont_schede">
        ...
        <div v-for="(movie, index) in movies" :key="movie.id" :ref="addSchedaRef" class="scheda sl">
          <NuxtLink :href="`/film/${movie.nome}`" class="link_poster click_poster" @click="clickmenu(index)" :ref="addLink"
          :data-title="movie.titolo.replace(/<[^>]*>/g, '').replace(/\s+/g, ' ').trim()"
          ><span>VIEW POSTER</span></NuxtLink>
